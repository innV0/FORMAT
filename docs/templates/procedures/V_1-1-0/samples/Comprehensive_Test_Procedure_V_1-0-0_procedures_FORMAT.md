...
* <!-- block: position --> Test Manager
  A position that assumes the Role with Relations role. Tests the positions-roles matrix relationship and that the position appears in the correct matrix row.

* <!-- block: position --> Senior Tester
  A position that assumes both the Role with Scope Internal and Role with Relations roles. Tests multi-role assumption in the positions-roles matrix.

* <!-- block: position --> Position with No Role
  A position defined but not linked to any role in the positions-roles matrix. Tests orphan position handling.

# <!-- block: concepts --> person

* <!-- block: person --> John Smith
  A person who occupies the Test Manager position. Tests the persons-positions matrix relationship.

* <!-- block: person --> Jane Doe
  A person who occupies the Senior Tester position. Tests the persons-positions matrix with a different person-position pair.

* <!-- block: person --> Unassigned Person
  A person defined but not linked to any position. Tests orphan person handling.
...
| position \ roles | Role with No Fields | Role with Scope Internal | Role with Scope External | Role with Relations | Role as Orphan |
| :--- | :---: | :---: | :---: | :---: | :---: |
| Test Manager | - | - | - | Assumes | - |
| Senior Tester | - | Assumes | - | Assumes | - |
| Position with No Role | - | - | - | - | - |

# <!-- block: matrices --> persons-positions matrix

| person \ position | Test Manager | Senior Tester | Position with No Role |
| :--- | :---: | :---: | :---: |
| John Smith | Occupies | - | - |
| Jane Doe | - | Occupies | - |
| Unassigned Person | - | - | - |

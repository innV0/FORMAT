...
describe('Document Notice (§3.1)', () => {
  it('serializes the GFM [!NOTE] admonition as the first block of the body', () => {
    ...
    expect(serialized).toContain('https://format.innv0.com/documentation/onboarding');
  });
...
> [!NOTE]
> This is a **FORMAT document** — a plain-text Markdown file that carries its own schema in the YAML frontmatter. New to FORMAT? The [onboarding guide](https://format.innv0.com/documentation/onboarding) walks you through what this is and how to open it in the visual editor.

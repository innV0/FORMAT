<template>
  <div>
    ...
    <select
      ...
      class="w-full mt-1 border border-slate-200 rounded-md p-2 text-xs focus:ring-1 focus:ring-indigo-500 outline-none bg-white cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
    >
